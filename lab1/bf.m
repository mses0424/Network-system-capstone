...
assert(fid ~= -1, '找不到 network.pos 檔案');
line1 = textscan(fid, '%f %f %f %f %f', 1);
P_tx_dBm = line1{1};    % Tx power
N0_dBm = line1{2};      % Noise power
freq = line1{3};        % Frequency
BW = line1{4};          % Bandwidth
P_rx_th_dBm = line1{5}; % Rx threshold
